...
function handlepopup(){
  ...
  <svg onClick={()=>setaddmail(false)} xmlns="http:www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
 ...
 <div class="d-flex">
   ...
   <button onClick={()=>{setaddmail(false);setshowtitle(true)}} class="btn btn-light">CANCEL</button>
 </div>
</form>
</div>
</div>
