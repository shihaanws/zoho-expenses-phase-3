...
const MenuProps = {
  ...
  const [personName, setPersonName] = useState('Petty Cash');
 ...
 >
        <div className={styles.leftitems}>
          ...
          >
            <Typography variant="h6">{head} Web tabs</Typography>
          </div>
        ...
        <DialogContent>
          <DialogContentText>
            <div className={styles.fieldContainer}>
              <h5 style={{ color: "#b94a48" }}>Name*</h5>
              <TextField></TextField>
              <h5 style={{ color: "#b94a48" }}>URL*</h5>
              <TextField></TextField>
              ...
              <FormControl component="fieldset">
                ...
                >
                    <FormControlLabel value="female" control={<Radio />} label="Only Me" />
                    <FormControlLabel value="male" control={<Radio />} label="Only Selected Users and Roles" />
                    <FormControlLabel value="other" control={<Radio />} label="Everyone" />
                </RadioGroup>
                </FormControl>
            </div>
          </DialogContentText>
